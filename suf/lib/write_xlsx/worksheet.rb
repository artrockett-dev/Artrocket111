...
require_relative 'xml_writer_simple'
...
module Writexlsx
  class Worksheet
    ...
    def prepare_chart(index, chart_id, drawing_id) # :nodoc:
      ...
      # Create a Drawing object to use with worksheet unless one already exist.
